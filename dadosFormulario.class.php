...
class DadosFormulario {
	...
	/**
	 * Construtor da classe Dados Formulario
	 *
	 * Conecta-se ao banco de dados toda vez que um objeto é instanciado
	 */
	public function __construct(){
		try {
			$this->pdo = new PDO("mysql:dbname=galhardo_620;host=localhost", "galhardo_620", "lecoBR@159");
	 ...
	 * @return [type]                   [description]
	 */
	public function adicionarDadosEndereco($rua, 
		                                   $bairro, 
		                                   $numeroResidencia) {
		$sql = "INSERT INTO dados_endereco (rua, bairro, numeroResidencia) VALUES (:rua, :bairro, :numeroResidencia)";
